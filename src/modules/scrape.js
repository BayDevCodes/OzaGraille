...
pdfReader(`./src/assets/menu/menu.pdf`).then(pdfData => {
                    ...
                    if (text.y > content[1].min && text.y < content[1].max) {
                        if (content[0] == "date") {
                            months.forEach(month => {
                                if (text.str.includes(month[0])) text.str = `${month[1]}/${text.str.replace(/[a-z]/gi, '')}/${new Date().getFullYear()}`;
                            });
                        };
                        ...
                        menu[text.page][day[0]][content[0]]
    ...
    if (existsSync(`./src/assets/menu/menu.json`)) rmSync(`./src/assets/menu/menu.json`);
    appendFileSync(`./src/assets/menu/menu.json`, JSON.stringify(menu, null, 2));
